...
import { FunnelUpdateOneWithoutLinkedAccountsInput } from "../inputs/FunnelUpdateOneWithoutLinkedAccountsInput.input";
import { StringFieldUpdateOperationsInput } from "../inputs/StringFieldUpdateOperationsInput.input";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class FunnelAccountUpdateWithoutDomainsInput {
  ...
  @TypeGraphQL.Field(_type => FunnelUpdateOneWithoutLinkedAccountsInput, {
    nullable: true
  })
  Funnel?: FunnelUpdateOneWithoutLinkedAccountsInput | undefined;
}
