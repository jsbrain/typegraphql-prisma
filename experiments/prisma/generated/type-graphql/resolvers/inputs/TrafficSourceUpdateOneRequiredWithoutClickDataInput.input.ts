...
import { TrafficSourceUpsertWithoutClickDataInput } from "../inputs/TrafficSourceUpsertWithoutClickDataInput.input";
import { TrafficSourceWhereUniqueInput } from "../inputs/TrafficSourceWhereUniqueInput.input";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class TrafficSourceUpdateOneRequiredWithoutClickDataInput {
  ...
  @TypeGraphQL.Field(_type => TrafficSourceUpsertWithoutClickDataInput, {
    nullable: true
  })
  upsert?: TrafficSourceUpsertWithoutClickDataInput | undefined;
  ...
  update?: TrafficSourceUpdateWithoutClickDataInput | undefined;
}
