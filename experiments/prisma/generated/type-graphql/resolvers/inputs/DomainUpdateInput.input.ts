...
import { FunnelAccountUpdateOneWithoutDomainsInput } from "../inputs/FunnelAccountUpdateOneWithoutDomainsInput.input";
...
export class DomainUpdateInput {
  ...
  @TypeGraphQL.Field(_type => FunnelAccountUpdateOneWithoutDomainsInput, {
    nullable: true
  })
  FunnelAccount?: FunnelAccountUpdateOneWithoutDomainsInput | undefined;
}
